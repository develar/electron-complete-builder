...
interface PromiseConstructor {
    ...
    promisify<T, A1, A2>(func: (arg1: A1, arg2: A2, callback: (error: Error) => void) => void, receiver?: any): (arg1: A1, arg2: A2) => Promise<T>;
    ...
    using<T>(promises: Array<Promise<any> | Disposer | any>, handler?: (results: Array<any>) => T): Promise<T>
    ...
    //map<T, U>(values: T[] | Iterable<T>, mapper: (item: T, index: number, arrayLength: number) => U, options?: Promise.ConcurrencyOption): Promise<U[]>;

    map<I, R>(input: Iterable<I>, mapper: (item: I, index: number, length: number) => Promise<R>, options?: Promise.ConcurrencyOption): Promise<R[]>;
